...
const HeroSection = () => {
    return (
        <div className='heroSection'>
            <div className="absolute top-[203px] left-[calc(50%_-_407px)] flex flex-col items-center justify-start gap-[52px]">
              ...
              <span className="heroHeaderWith font-nunito-sans">ease</span>
                ...
                <div className="w-[814px] h-[148px] flex flex-row items-center justify-start font-nunito">
                    ...
                    <img
                        ...
                        alt=""
                        src="../../public/images/svg/convert-icon.svg"
                    />
                            ...
                            <div className="flex flex-row items-center justify-start gap-[36.28px]">
                                <div className="w-[99.16px] flex flex-row items-center justify-start gap-[7.26px]">
                                    <img
                                        ...
                                        src="../../public/images/svg/frame-650.svg"
                                    />
                                    <div className="relative leading-[25.4px] uppercase">
                                        NSWAP
                                    </div>
                                </div>
                                <img
